#ifndef ROOT_FadcRaster_H 
#define ROOT_FadcRaster_H
...
class FadcRaster : public THaBeamDet {

public:
  FadcRaster( const char* name, const char* description = "",
		   THaApparatus* a = NULL );
  virtual ~FadcRaster();
...
protected:
  ...
  //  FadcRaster() {}
  //  FadcRaster( const FadcRaster& ) {}
  //  FadcRaster& operator=( const FadcRaster& ) { return *this; }
  ...
  ClassDef(FadcRaster,0)   // Generic Raster class 
};
