...
//_____________________________________________________________________________
Int_t FadcBPM::ReadDatabase( const TDatime& date )
{
...
//_____________________________________________________________________________
Int_t FadcBPM::DefineVariables( EMode mode )
{
...
//_____________________________________________________________________________
Int_t FadcBPM::Decode( const THaEvData& evdata )
{
  ...
  // std::cout << "FadcBPM::Decode() calling THaDetMap::Print() " << std::endl;
  // fDetMap->Print(); 
  // std::cout << "FadcBPM: detMapSize = " << detMapSize << std::endl; 
