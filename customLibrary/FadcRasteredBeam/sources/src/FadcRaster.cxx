...
//_____________________________________________________________________________
Int_t FadcRaster::ReadDatabase( const TDatime& date )
{
...
Int_t FadcRaster::DefineVariables( EMode mode )
{
...
//______________________________________________________________________________
void FadcRaster::Clear( Option_t* )
{
...
//______________________________________________________________________________
Int_t FadcRaster::Decode( const THaEvData& evdata )
{
  ...
  // std::cout << "FadcRaster::Decode() calling THaDetMap::Print()" << std::endl;
  // fDetMap->Print();
  // std::cout << "FadcRaster: detMapSize = " << detMapSize << std::endl;
